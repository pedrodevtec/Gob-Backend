Warning: truncated output (original token count: 39446)
Total output lines: 3220
...
export const openApiDocument = {
  ...
  components: {
    ...
    schemas: {
      ...
      AdminMonsterRequest: {
        type: "object",
…19446 tokens truncated…      delete: { tags: ["Admin"], summary: "Excluir produto da loja", security: authSecurity, parameters: [idPathParam], responses: { "200": { description: "Produto excluido" }, "404": { $ref: "#/components/responses/NotFound" }, "409": { $ref: "#/components/responses/Conflict" } } },
    },
    "/api/v1/tables": {
